...
def universal_all(input_str,coordinates,queue=None,func_name=None):
    ...
    for coordinate in coordinates:
        bit_string = map(lambda x:int(x),input_str[coordinate[0]:coordinate[1]+1])
        success,p_value,t = maurers_universal_test(input_str)
...
if __name__ == "__main__":
    ...
    bits = map(lambda x:int(x),"01011010011101010111")
