...
def main():
    ...
    p_array = []
    q_array = []
    base_file_path = local_settings
    input_str = open("./TestData/test.bin.enc.char", "rb").read(1000000000)
    segment_size = 128
    ...
    for m in m_set:
        for i in xrange(0,m+1):
            ...
            for coordinate in coordinates:
                ...
                p_array.append(p)
                q_array.append(q)
            p_temp = VLVisualize.vl_plot1d(p_array=p_array,q_array=q_array,m=m,mod="p",source="ANU_3May2012_100MB",ylim=1,rs=i)
            q_temp = VLVisualize.vl_plot1d(p_array=p_array,q_array=q_array,m=m,mod="q",source="ANU_3May2012_100MB",ylim=1,rs=i)

            twodq_temp = VLVisualize.vl_plot2d(p_array=p_array,q_array=q_array,m=m,mod="2dq",source="ANU_3May2012_100MB",rs=i)
            twodp_temp = VLVisualize.vl_plot2d(p_array=p_array,q_array=q_array,m=m,mod="2dp",source="ANU_3May2012_100MB",rs=i)
            pq_temp = VLVisualize.vl_plot2d(p_array=p_array,q_array=q_array,m=m,mod="2dpq",source="ANU_3May2012_100MB",rs=i)
            if i == 0:
                p_count_max = p_temp
        ...
        VLVisualize.plot1d(range(0,m+1),p_count_array,{"mod":"p_count","rs":i,"source":"ANU_3May2012_100MB","m":m})
        VLVisualize.plot1d(range(0,m+1),q_count_array,{"mod":"q_count","rs":i,"source":"ANU_3May2012_100MB","m":m})
        VLVisualize.plot1d(range(0,m+1),twodp_count_array,{"mod":"2dp_count","rs":i,"source":"ANU_3May2012_100MB","m":m})
        VLVisualize.plot1d(range(0,m+1),twodq_count_array,{"mod":"2dq_count","rs":i,"source":"ANU_3May2012_100MB","m":m})
        VLVisualize.plot1d(range(0,m+1),pq_count_array,{"mod":"pq_count","rs":i,"source":"ANU_3May2012_100MB","m":m})
